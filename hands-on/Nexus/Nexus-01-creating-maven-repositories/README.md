...
```
mvn
curl http://169.254.169.254/latest/meta-data/3.235.104.113
vim /home/ec2-user/.m2/settings.xml
```
...
<settings>
  <mirrors>
    <mirror>
      ...
      <id>nexus</id>
      <mirrorOf>*</mirrorOf>
      <url>http://3.235.104.113:8081/repository/maven-proxy-hands-on/</url>
    </mirror>
  </mirrors>
  <profiles>
    <profile>
