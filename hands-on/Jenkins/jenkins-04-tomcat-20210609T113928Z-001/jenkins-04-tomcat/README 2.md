...
- In able to declare a service "unit file" must be created. Create a `tomcat.service` file. ### important
...
- Copy and paste this code in "tomcat.service" file. for automating tomcat.service
